...
def search_command():
    list.delete(0,END)
    for row in backend.search(date_text.get(),int(expenditure_text.get()),exercise_text.get(),study_text.get(),diet_text.get(),coding_text.get()):
        list.insert(END,row)

def add_command():
    backend.insert(date_text.get(),int(expenditure_text.get()),exercise_text.get(),study_text.get(),diet_text.get(),coding_text.get())
    list.delete(0,END)
    list.insert(END,(date_text.get(),int(expenditure_text.get()),exercise_text.get(),study_text.get(),diet_text.get(),coding_text.get()))

win=Tk()

win.title('My Routine Database')         # or win.wm_title()
...
expenditure_text=StringVar()
e2=Entry(win,textvariable=expenditure_text)
